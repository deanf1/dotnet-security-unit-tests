...
<body>
    ...
    <a href="codeview.aspx?type=xpath&var=<%= Request.QueryString["var"] %>">View code for this test</a>
    <br /><br />
    ...
    %></textarea>
    <% Response.Write("<form id=\"theform\" action=\"TestCases/XPathTestCases/" + Request.QueryString["var"] + ".aspx\" method=\"get\" autocomplete=\"off\" runat=\"server\">"); %>
